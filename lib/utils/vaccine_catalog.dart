...
class VaccineCatalog {
  ...
  static const List<VaccineOption> options = [
    VaccineOption(payloadName: 'BCG', displayLabel: 'BCG (Tuberculosis)'),
    VaccineOption(payloadName: 'Hepatitis B', displayLabel: 'Hepatitis B'),
    VaccineOption(
    ...
    VaccineOption(payloadName: 'IPV', displayLabel: 'IPV'),
  ...
  static final Map<String, _SeriesMeta> _seriesLookup = {
    ...
    'IPV': _SeriesMeta(seriesLabel: 'IPV', totalDoses: 1, doseNumber: 1),
